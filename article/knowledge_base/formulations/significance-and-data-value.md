...
2. **Censoring-aware обучение** — нельзя выбрасывать «неудавшиеся»/незавершённые опыты: каждый дорогой прогон должен учиться (liquefied — точно, stabilized — право-цензурировано, unfinished — на траекторию). Выбрасывание = выбрасывание денег и недель. → [[../protocol/ablations]] (Censoring/Tobit) · [[../literature/cox-1972]]
