...
5. **Censored N_liq.** Если onset не наступил в горизонте опыта — **право-цензурированное** наблюдение, не обычная регрессионная метка. N_liq выдаётся выделенной головой, регуляризованной к пересечению кривой (не строго лежит на ней) — оговорить в methods/limitations. → [[../literature/cox-1972]] [[../literature/nafday-2010]]
