"""
Интерактивная визуализация модельных кривых на Plotly.

Универсальные построители графиков аналитических функций: одиночная кривая модели
с опциональным наложением экспериментальных точек и наложение нескольких кривых на
одной сетке по оси X с поддержкой второй оси Y (например, PPR/g(N) слева и поровое
давление u в кПа справа) и логарифмических шкал.
"""
