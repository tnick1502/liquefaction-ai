"""
Модели роста и диссипации порового давления PPR (Pore Pressure Ratio).

Реализованы законы из литературы по росту порового давления при циклическом
нагружении: CPT-инспирированная модель Ма и Ванга (экспоненциальный рост и
гиперболическое насыщение), её расширенный вариант с логарифмическим длинным хвостом
и логарифмическая модель роста/диссипации с аналитической точкой экстремума.
Функции возвращают как сам PPR(N), так и вспомогательные величины (поровое давление
u(N), точку пика N_peak, масштабирующий коэффициент C).

Все функции принимают скаляр или массив и возвращают результат соответствующего типа.
"""
