"""
Базовые регрессионные метрики общего назначения.

Лёгкие чистые функции для оценки точечных предсказаний: коэффициент детерминации R²,
среднеквадратичная ошибка MSE и взвешенная абсолютная процентная ошибка WAPE.
"""
...
__all__ = ["compute_r2", "compute_mse", "compute_wape"]
