...
def make_loo_object_folds(
    ...
    """
    **Вторичный протокол P0:** leave-one-site-out по всем площадкам (самая честная межплощадочная
    оценка обобщения). Каждая ``site_id`` по очереди — единственный test; из остальных выделяется
