"""
Тесты цензур-протокола N_liq.

Проверяют функцию потерь :func:`masked_censored_nliq_loss` — полную ошибку для разжижения,
одностороннюю (Tobit) цензуру для наблюдаемого non-liq и исключение по маске для незавершённых.
"""
import numpy as np
import torch
